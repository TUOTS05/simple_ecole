...
class FinancialReportController extends Controller
{
    ...
    //     // Réutiliser la même logique que unpaidByClass()
    //     $classes = DB::table('school_classes')
    //         ->select(
    //             'school_classes.id as class_id',
    //             'school_classes.name as class_name',
    ...
    //     $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('app.financial.exports.unpaid_by_class_pdf', compact('classes', 'globalStats', 'schoolYear'));
    //     return $pdf->download('impayes_par_classe_' . date('Y-m-d') . '.pdf');
    // }
    ...
    //     $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('app.financial.exports.class_detail_pdf', compact('class', 'students', 'schoolYear'));
    ...
    //         'student', 'enrollment', 'installments', 'payments',
    //         'totalDue', 'totalPaid', 'totalRemaining', 'paymentRate', 'schoolYear'
    //     ));
