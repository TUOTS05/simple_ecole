...
<head>
    <meta charset="UTF-8">
    <title>Reçu Goûter N°{{ str_pad($payment->id, 6, '0', STR_PAD_LEFT) }}</title>
    <style>
        @page {
            size: A5 portrait;
            margin: 10mm;
...
<body>
    ...
    <div class="receipt-container">
        ...
        <div class="title-section">
            <div class="title-main">REÇU GOÛTER N°: {{ str_pad($payment->id, 6, '0', STR_PAD_LEFT) }}</div><hr>
        </div>
        ...
        <table>
            <tr>
                ...
                <td width="50%">
                    ...
                    <span class="form-value">{{ $payment->receivedByUser->full_name ?? ($payment->receivedByUser->name ?? 'Le Comptable') }}</span>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <span class="form-value">Goûter {{ $schoolYear ? '- ' . $schoolYear->name : '' }}</span>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <span class="form-value">{{ ucfirst(str_replace('_', ' ', $payment->payment_method ?? 'Espèces')) }}</span>
                </td>
            </tr>
        </table>
        ...
        <div style="text-align: center; font-weight: bold; margin-top: 15px; padding: 8px;">
            ✅ Le goûter de l'année est entièrement soldé !
        </div>
        @endif
