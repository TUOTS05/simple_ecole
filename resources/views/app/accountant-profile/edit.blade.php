    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-1">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
                ...
                <p class="text-gray-500 text-sm mt-1">Personnel comptable</p>
        ...
        <div class="md:col-span-2 space-y-6">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <form action="{{ route('app.accountant-profile.update') }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center">
                                <input type="radio" name="gender" value="M" {{ old('gender', $user->gender) == 'M' ? 'checked' : '' }} required class="w-4 h-4 text-primary focus:ring-primary">
                                <span class="ml-2 text-sm text-gray-700">Masculin</span>
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="gender" value="F" {{ old('gender', $user->gender) == 'F' ? 'checked' : '' }} required class="w-4 h-4 text-primary focus:ring-primary">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <form action="{{ route('app.accountant-profile.password.update') }}" method="POST">
                    @csrf
                    @method('PUT')
