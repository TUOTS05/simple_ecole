    ...
    <form action="{{ route('app.students.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                @include('app.students._partials.identity-fields', [
                    'classes' => $classes,
                    'requireFamilyChoice' => true,
                    'statusOptionLabel' => 'Inactif (En attente)',
                ])
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                @include('app.students._partials.guardian-fields', [
                    'guardianOccupationLabel' => 'Occupation du gardien',
                    'showGuardianPhoneError' => true,
                ])
            </div>
        </div>
