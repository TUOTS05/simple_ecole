...
@section('title', 'Nouveau Comptable')
@section('page_title', 'Ajouter un membre du personnel comptable')

@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow p-6">
            <p class="text-sm text-gray-500 mb-6">Ce compte n'aura accès qu'aux inscriptions et aux paiements.</p>
            <form action="{{ route('app.accountants.store') }}" method="POST">
                @csrf
                @if($errors->any())
