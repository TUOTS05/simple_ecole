    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            color: #333;
            line-height: 1.3;
            padding: 15mm; /* Marge autour du cadre */
        }

        /* ✅ CADRE GLOBAL AUTOUR DU BULLETIN */
        .bulletin-container {
            border: 2px solid #000; /* Remplacez #000 par #1e40af pour un cadre bleu */
            padding: 15px;
            min-height: 267mm; /* S'assure que le cadre descend jusqu'en bas de la page A4 */
        }
...
<body>
    ...
    <div class="bulletin-container">
        ...
        <!-- En-tête : Logo à gauche (avec année en dessous), Infos école à droite -->
        ...
        <!-- Titre du bulletin (Centré en dessous) -->
        ...
        <table class="grades">
            ...
            <tbody>
                ...
                <!-- Ligne Moyenne Générale (Alignée dans la colonne NOTE/20) -->
                <tr>
        ...
        <!-- Résumé (✅ Les 3 éléments sont maintenant sur la MÊME LIGNE) -->
        <div class="summary">
        ...
        <!-- Pied de page (Sans les traits de soulignement) -->
        <div class="footer">
            Fait à: {{ $school->city ?? 'Abidjan' }}<br>
            Le: {{ now()->format('d/m/Y') }}
        </div>
