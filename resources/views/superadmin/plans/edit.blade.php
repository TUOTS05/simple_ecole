                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" id="monthly_price" name="monthly_price" value="{{ old('monthly_price', $plan->monthly_price) }}" required min="0" step="0.01"
                            ...
                            <div>
                                ...
                                <div class="w-full px-4 py-2 border border-gray-200 bg-gray-50 rounded-lg text-gray-600">
                                    <span id="yearly_price_preview">{{ number_format(old('monthly_price', $plan->monthly_price) * 12, 0, ',', ' ') }}</span> FCFA/an
                                </div>
