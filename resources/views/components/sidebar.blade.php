    ...
    <nav class="flex-1 p-2 space-y-1 overflow-y-auto custom-scrollbar">
        ...
        <div x-data="{ open: {{ request()->routeIs('extras.*') ? 'true' : 'false' }} }" class="space-y-1">
            ...
            <div x-show="open && sidebarOpen" x-transition class="pl-11 space-y-1">
                ...
                <a href="{{ route('extras.refunds.index') }}" class="block px-4 py-2 text-sm rounded-md transition {{ request()->routeIs('extras.refunds.*') ? 'bg-primary/10 text-primary font-semibold' : 'text-gray-600 hover:text-primary hover:bg-gray-50' }}">Remboursements</a>
